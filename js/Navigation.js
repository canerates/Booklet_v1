...
var getCategories = function (callback) {
    if (location.protocol == 'file:') {
        ...
        if (isLanguageValid(page.language)) {
            if (containsArray(page.languageList, page.language)) {
                script.src = "js/categories/Categories_" + page.language + ".js?v=" + Math.random();
            }
            else {
                script.src = "js/categories/Categories_eng.js?v=" + Math.random();
            }
        }
